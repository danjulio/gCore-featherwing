 ...
 * @file STMPE610.c
 *
 * ESP32 driver for the STMPE610 resistive touchscreen controller
 *
 */
...
/** This will need adjusting to your specific touchscreen. **/
/** Uncomment the logging in smtpe610_read(), and note the **/
/** x and y readings as you touch the edge of your display **/
/**                         Ymax                           **/
/**                                                        **/
/**  Xmin                                           Xmax   **/
/**                                                        **/
...
#define STMPE610_Y_MIN       210
#define STMPE610_X_MAX       3810
#define STMPE610_Y_MAX       3860
#define STMPE610_XY_SWAP     1
#define STMPE610_X_INV       0
#define STMPE610_Y_INV       1
