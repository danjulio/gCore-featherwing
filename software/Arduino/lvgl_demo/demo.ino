...
lv_img_dsc_t img_bubble_pattern;
#endif
...
#if LV_DEMO_WALLPAPER
    img_bubble_pattern.header.always_zero = 0;
    img_bubble_pattern.header.w = 234;
    img_bubble_pattern.header.h = 480;
    img_bubble_pattern.data_size = 112320 * LV_COLOR_SIZE / 8;
    img_bubble_pattern.header.cf = LV_IMG_CF_TRUE_COLOR;
    img_bubble_pattern.data = img_bubble_pattern_map;
